...
mixin _$TransactionDto {
 ...
 String get id; String get bookingId; String get payerUserId; int get amountCents; String get currencyCode; String get method; String get status; String? get proofUrl; String? get referenceCode; String? get reviewedByAdminId;@TimestampDateTimeConverter() DateTime get createdAt;@TimestampDateTimeConverter() DateTime? get reviewedAt; String? get reviewComment;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,bookingId,payerUserId,amountCents,currencyCode,method,status,proofUrl,referenceCode,reviewedByAdminId,createdAt,reviewedAt,reviewComment);
...
@useResult
$Res call({
 String id, String bookingId, String payerUserId, int amountCents, String currencyCode, String method, String status, String? proofUrl, String? referenceCode, String? reviewedByAdminId,@TimestampDateTimeConverter() DateTime createdAt,@TimestampDateTimeConverter() DateTime? reviewedAt, String? reviewComment
});
...
/// Create a copy of TransactionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? bookingId = null,Object? payerUserId = null,Object? amountCents = null,Object? currencyCode = null,Object? method = null,Object? status = null,Object? proofUrl = freezed,Object? referenceCode = freezed,Object? reviewedByAdminId = freezed,Object? createdAt = null,Object? reviewedAt = freezed,Object? reviewComment = freezed,}) {
...
as String?,reviewedByAdminId: freezed == reviewedByAdminId ? _self.reviewedByAdminId : reviewedByAdminId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String bookingId,  String payerUserId,  int amountCents,  String currencyCode,  String method,  String status,  String? proofUrl,  String? referenceCode,  String? reviewedByAdminId, @TimestampDateTimeConverter()  DateTime createdAt, @TimestampDateTimeConverter()  DateTime? reviewedAt,  String? reviewComment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionDto() when $default != null:
return $default(_that.id,_that.bookingId,_that.payerUserId,_that.amountCents,_that.currencyCode,_that.method,_that.status,_that.proofUrl,_that.referenceCode,_that.reviewedByAdminId,_that.createdAt,_that.reviewedAt,_that.reviewComment);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String bookingId,  String payerUserId,  int amountCents,  String currencyCode,  String method,  String status,  String? proofUrl,  String? referenceCode,  String? reviewedByAdminId, @TimestampDateTimeConverter()  DateTime createdAt, @TimestampDateTimeConverter()  DateTime? reviewedAt,  String? reviewComment)  $default,) {final _that = this;
switch (_that) {
case _TransactionDto():
return $default(_that.id,_that.bookingId,_that.payerUserId,_that.amountCents,_that.currencyCode,_that.method,_that.status,_that.proofUrl,_that.referenceCode,_that.reviewedByAdminId,_that.createdAt,_that.reviewedAt,_that.reviewComment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String bookingId,  String payerUserId,  int amountCents,  String currencyCode,  String method,  String status,  String? proofUrl,  String? referenceCode,  String? reviewedByAdminId, @TimestampDateTimeConverter()  DateTime createdAt, @TimestampDateTimeConverter()  DateTime? reviewedAt,  String? reviewComment)?  $default,) {final _that = this;
switch (_that) {
case _TransactionDto() when $default != null:
return $default(_that.id,_that.bookingId,_that.payerUserId,_that.amountCents,_that.currencyCode,_that.method,_that.status,_that.proofUrl,_that.referenceCode,_that.reviewedByAdminId,_that.createdAt,_that.reviewedAt,_that.reviewComment);case _:
  return null;
...
class _TransactionDto extends TransactionDto {
  const _TransactionDto({required this.id, required this.bookingId, required this.payerUserId, required this.amountCents, required this.currencyCode, required this.method, required this.status, this.proofUrl, this.referenceCode, this.reviewedByAdminId, @TimestampDateTimeConverter() required this.createdAt, @TimestampDateTimeConverter() this.reviewedAt, this.reviewComment}): super._();
  factory _TransactionDto.fromJson(Map<String, dynamic> json) => _$TransactionDtoFromJson(json);

@override final  String id;
@override final  String bookingId;
@override final  String payerUserId;
...
@override@TimestampDateTimeConverter() final  DateTime? reviewedAt;

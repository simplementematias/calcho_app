...
mixin _$BookingDto {
 ...
 String get id; String get venueId; String get courtId; String get createdByUserId; List<String> get participantUserIds;@TimestampDateTimeConverter() DateTime get startAt;@TimestampDateTimeConverter() DateTime get endAt; int get totalPriceCents; int get approvedAmountCents; String get currencyCode; String get status;@TimestampDateTimeConverter() DateTime get createdAt;@TimestampDateTimeConverter() DateTime get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookingDto&&(identical(other.id, id) || other.id == id)&&(identical(other.venueId, venueId) || other.venueId == venueId)&&(identical(other.courtId, courtId) || other.courtId == courtId)&&(identical(other.createdByUserId, createdByUserId) || other.createdByUserId == createdByUserId)&&const DeepCollectionEquality().equals(other.participantUserIds, participantUserIds)&&(identical(other.startAt, startAt) || other.startAt == startAt)&&(identical(other.endAt, endAt) || other.endAt == endAt)&&(identical(other.totalPriceCents, totalPriceCents) || other.totalPriceCents == totalPriceCents)&&(identical(other.approvedAmountCents, approvedAmountCents) || other.approvedAmountCents == approvedAmountCents)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode)&&(identical(other.status, status) || other.status == status)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,venueId,courtId,createdByUserId,const DeepCollectionEquality().hash(participantUserIds),startAt,endAt,totalPriceCents,approvedAmountCents,currencyCode,status,createdAt,updatedAt);
...
@useResult
$Res call({
 String id, String venueId, String courtId, String createdByUserId, List<String> participantUserIds,@TimestampDateTimeConverter() DateTime startAt,@TimestampDateTimeConverter() DateTime endAt, int totalPriceCents, int approvedAmountCents, String currencyCode, String status,@TimestampDateTimeConverter() DateTime createdAt,@TimestampDateTimeConverter() DateTime updatedAt
});
...
/// Create a copy of BookingDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? venueId = null,Object? courtId = null,Object? createdByUserId = null,Object? participantUserIds = null,Object? startAt = null,Object? endAt = null,Object? totalPriceCents = null,Object? approvedAmountCents = null,Object? currencyCode = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
as List<String>,startAt: null == startAt ? _self.startAt : startAt // ignore: cast_nullable_to_non_nullable
as DateTime,endAt: null == endAt ? _self.endAt : endAt // ignore: cast_nullable_to_non_nullable
as DateTime,totalPriceCents: null == totalPriceCents ? _self.totalPriceCents : totalPriceCents // ignore: cast_nullable_to_non_nullable
as int,approvedAmountCents: null == approvedAmountCents ? _self.approvedAmountCents : approvedAmountCents // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _BookingDto() when $default != null:
return $default(_that.id,_that.venueId,_that.courtId,_that.createdByUserId,_that.participantUserIds,_that.startAt,_that.endAt,_that.totalPriceCents,_that.approvedAmountCents,_that.currencyCode,_that.status,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _BookingDto extends BookingDto {
  const _BookingDto({required this.id, required this.venueId, required this.courtId, required this.createdByUserId, required final  List<String> participantUserIds, @TimestampDateTimeConverter() required this.startAt, @TimestampDateTimeConverter() required this.endAt, required this.totalPriceCents, required this.approvedAmountCents, required this.currencyCode, required this.status, @TimestampDateTimeConverter() required this.createdAt, @TimestampDateTimeConverter() required this.updatedAt}): _participantUserIds = participantUserIds,super._();
...
@override List<String> get participantUserIds {
...
@override@TimestampDateTimeConverter() final  DateTime startAt;
@override@TimestampDateTimeConverter() final  DateTime endAt;
@override final  int totalPriceCents;
@override final  int approvedAmountCents;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BookingDto&&(identical(other.id, id) || other.id == id)&&(identical(other.venueId, venueId) || other.venueId == venueId)&&(identical(other.courtId, courtId) || other.courtId == courtId)&&(identical(other.createdByUserId, createdByUserId) || other.createdByUserId == createdByUserId)&&const DeepCollectionEquality().equals(other._participantUserIds, _participantUserIds)&&(identical(other.startAt, startAt) || other.startAt == startAt)&&(identical(other.endAt, endAt) || other.endAt == endAt)&&(identical(other.totalPriceCents, totalPriceCents) || other.totalPriceCents == totalPriceCents)&&(identical(other.approvedAmountCents, approvedAmountCents) || other.approvedAmountCents == approvedAmountCents)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode)&&(identical(other.status, status) || other.status == status)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,venueId,courtId,createdByUserId,const DeepCollectionEquality().hash(_participantUserIds),startAt,endAt,totalPriceCents,approvedAmountCents,currencyCode,status,createdAt,updatedAt);
...
/// Create a copy of BookingDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? venueId = null,Object? courtId = null,Object? createdByUserId = null,Object? participantUserIds = null,Object? startAt = null,Object? endAt = null,Object? totalPriceCents = null,Object? approvedAmountCents = null,Object? currencyCode = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,}) {
